...
const VisaInformation = () => {
  return (
    <div className="visa-info">
      <h1 className="visa-info__title">Information about Vejshnorian Visas</h1>

      <h2 className="visa-info__section-title">Who Can Apply?</h2>
      <div className="visa-info__section-content">
        <p>
      ...
      <h2 className="visa-info__section-title">Required Documents</h2>
      <div className="visa-info__section-content">
        <p>
      ...
      <h2 className="visa-info__section-title">How Long Should I Wait?</h2>
      <div className="visa-info__section-content">
        <p>
          Visa processing times vary depending on the type of visa and the
          purpose of your visit. Generally, it can take anywhere from a few days
          to several weeks to process your visa application.
        </p>
      </div>

      <h2 className="visa-info__section-title">Fees</h2>
      <div className="visa-info__section-content">
        <p>
